...
void MainScreen::doSetup(HalDC* hal)
{
  ...
  //	screenButtons->addButton(5, 275, 190, 40, "Proba");
...
{  
  ...
  uint8_t fontHeight = 16;//hal->getFontHeight(SCREEN_SMALL_FONT);
  
  String adcString = F("ACP: ");
  adcString += adcValue;
  hal->print("* Universal Color TFT Display Library *", CENTER, 1);
...
{  
  ...
  // рисуем температуру
  String tempString = F("Temperatura: ");
