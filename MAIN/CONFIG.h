...
#define ADC_MIN_BORDER 200 // минимальное значение порога аналогового датчика для экрана настроек
#define ADC_MIN_BORDER_DEFAULT_VAL 250 // значение минимального порога аналогового датчика по умолчанию
#define ADC_MAX_BORDER 1000 // максимальное значение порога аналогового датчика для экрана настроек
#define ADC_MAX_BORDER_DEFAULT_VAL 900 // значение максимального порога аналогового датчика по умолчанию
...
// настройки ESP
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#define ESP_SUPPORT_ENABLED // закомментировать, если не надо использовать ESP в прошивке
