...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void SettingsClass::setDriver(const String& val)
{
  writeString(DRIVER_ADDRESS,val,70);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
String SettingsClass::getDriver()
{
  String result = readString(DRIVER_ADDRESS,70);
  if(!result.length())
    result = DEFAULT_DRIVER;

  return result;  
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void SettingsClass::setVehicleNumber(const String& val)
{
  writeString(VEHICLE_NUMBER_ADDRESS,val,20);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
String SettingsClass::getVehicleNumber()
{
  String result = readString(VEHICLE_NUMBER_ADDRESS,20);
  if(!result.length())
    result = DEFAULT_VEHICLE_NUMBER;

  return result;  
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
void SettingsClass::setTrailerNumber(const String& val)
{
  writeString(TRAILER_NUMBER_ADDRESS,val,20);
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
String SettingsClass::getTrailerNumber()
{
  String result = readString(TRAILER_NUMBER_ADDRESS,20);
  if(!result.length())
    result = DEFAULT_TRAILER_NUMBER;
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//String SettingsClass::getDriver(uint8_t val)
//{
//  return readString(DRIVER_ADDRESS,val);
//}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//String SettingsClass::getVehicleNumber(uint8_t val)
//{
//  return readString(VEHICLE_NUMBER_ADDRESS,val);
//}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//String SettingsClass::getTrailerNumber(uint8_t val)
//{
// return readString(TRAILER_NUMBER_ADDRESS,val);
//}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
