...
class CommandHandlerClass
{
 ...
 private:
  ...
  bool getDRIVER(const char* commandPassed, const CommandParser& parser, Stream* pStream);
  bool setDRIVER(CommandParser& parser, Stream* pStream);
  
  bool getVEHICLENUMBER(const char* commandPassed, const CommandParser& parser, Stream* pStream);
  bool setVEHICLENUMBER(CommandParser& parser, Stream* pStream);

  bool getTRAILERNUMBER(const char* commandPassed, const CommandParser& parser, Stream* pStream);
  bool setTRAILERNUMBER(CommandParser& parser, Stream* pStream);
