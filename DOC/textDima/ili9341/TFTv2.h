...
#define TFT_CS_LOW  digitalWrite(9,LOW) //{DDRD |= 0x20;PORTD &=~ 0x20;}
#define TFT_CS_HIGH  digitalWrite(9,HIGH)//{DDRD |= 0x20;PORTD |=  0x20;}
#define TFT_DC_LOW  digitalWrite(8,LOW)//{DDRD |= 0x40;PORTD &=~ 0x40;}
#define TFT_DC_HIGH digitalWrite(8,HIGH)//{DDRD |= 0x40;PORTD |=  0x40;}
#define TFT_BL_OFF  digitalWrite(11,HIGH)//{DDRD |= 0x80;PORTD &=~ 0x80;}
#define TFT_BL_ON   digitalWrite(11,LOW)//{DDRD |= 0x80;PORTD |=  0x80;}
#define TFT_RST_OFF digitalWrite(7,HIGH)//{DDRD |= 0x10;PORTD |=  0x10;}
#define TFT_RST_ON  digitalWrite(7,LOW)//{DDRD |= 0x10;PORTD &=~ 0x10;}
/*
  #define CS 9
    #define RESET 7
    #define DC 8
